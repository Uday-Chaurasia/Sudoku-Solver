...
bool checkCol(int grid[][N], int n, int i) {
...
bool checkRow(int grid[][N], int n, int j) {
...
bool checkBlock(int grid[][N], int n, int i, int j) {

    // check which block is used
    int x = -1, y = -1; 
...
bool solve(int grid[][N]) {
    ...
    for(int n = 1; n < 10; n++) {
        ...
        if ((checkBlock(grid, n, i, j) && checkCol(grid, n, i) && checkRow(grid, n, j)) == true) {
